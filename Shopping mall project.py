...
#*******KRITHIKA PRIYA - CLASS CO1 
#*******VIJAYADHARSHNI - CLASS CO1
#*******MERLIN PRIYA - CLASS CO1 
...
def MYSQLconnectionCheck ():
    ...
    myConnection=mysql.connector.connect(host="localhost",user="root",passwd="1234" , auth_plugin='mysql_native_password' )
    if myConnection:
...
def MYSQLconnection ():
    ...
    myConnection=mysql.connector.connect(host="localhost",user=userName,passwd=password , database="EMIRATESI" ,auth_plugin='mysql_native_password' )
    if myConnection:
       return myConnection
    else:
...
def menSection():
    ...
    if myConnection:
        ...
        sql="SELECT * FROM PRODUCT WHEREPRODUCT_CATEGORY=%s"
...
print("#***************VELAMMAL VIDYALAYA***************")
print("#***************WELCOME TO THE MALL OF EMIRATES****")
print("################## THE MALL OF EMIRATESI ##########")
print("#*******Designed and Maintained By:")
print("#*******VIJAYADHARSHNI - CLASS XII CO1")
print("#*******KRITHIKA PRIYA- CLASS XII CO1")
print("#*******MERLIN PRIYA - CLASS XII CO1")
